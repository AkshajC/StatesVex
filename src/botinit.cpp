...
pros::Motor lB(-13, pros::E_MOTOR_GEARSET_18); // left back motor. port 12, reversed
pros::Motor rF(12, pros::E_MOTOR_GEARSET_18); // right front motor. port 19
pros::Motor rM(3, pros::E_MOTOR_GEARSET_18); // right middle motor. port 20
...
pros::Motor intake1(-17, pros::E_MOTOR_GEARSET_06);
...
pros::ADIDigitalOut hangDown('F');
pros::ADIDigitalOut vertWing('D');
pros::ADIDigitalOut flapLeftPiston('G'); // ************FIX W/ ADI EXPANDER
pros::ADIDigitalOut flapRightPiston('H');
