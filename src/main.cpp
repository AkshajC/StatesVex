...
void initialize() {
    ...
    pros::Task screenTask([&]() {
        ...
        while (true) {
            ...
            // pros::lcd::print(3, "Cata Rotation: %i", rot_sensor.get_position());
            pros::lcd::print(3, "LF Temp: %f", lF.get_position());
            pros::lcd::print(4, "RF Temp: %f", rF.get_position());
            pros::lcd::print(5, "LM Temp: %f", lM.get_position());
            pros::lcd::print(6, "RM Temp: %f", rM.get_position());
            pros::lcd::print(7, "LB Temp: %f", lB.get_position());
            pros::lcd::print(8, "RB Temp: %f", rB.get_position());
